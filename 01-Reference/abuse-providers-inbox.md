...
|----|----------|----------|-------------|----------|--------|-----------|---------|
| A-001 | **AnyModel** | `https://anymodel.org/v1` | 5M токенов за Telegram, GPT-6 Astra, Claude Fable 5, Opus 5, Kimi K3, Grok 4.6, GLM 5.3, DeepSeek V4 Pro, Gemini 3.1 Pro, Qwen 3.8 Max. Множители: Astra ×6, Fable 5 ×16 | [post 831](https://t.me/inbox_tools/831) |  inbox | 🔥 HIGH | OpenAI-compatible, pay-as-you-go после бонуса, некоторые модели от $0.0025/1M |
...
| A-003 | **AMD Radeon Cloud Token Factory** | `https://developer.amd.com.cn/radeon/api/v1` | `AMD_RADEON_API_KEY` | Официальный бесплатный API от AMD: DeepSeek-V4-Flash, DeepSeek-V4-Flash-Vision-Exp (1M контекст), Qwen3.8-Flash-Next (262K). Лимиты: 20 RPM, 8 параллельных, дневная квота ~$10 | [post 829](https://t.me/inbox_tools/829) |  inbox | 🔥 HIGH | **Официальный вендор**, OpenAI + Anthropic Messages, HIGH PRIORITY |
...
| A-007 | **DeepSeek bloodthemes** | `https://deepseek.bloodthemes.ru/v1` | Безлимитный DeepSeek: v4 pro, v4 flash, expert, reasoner | [post 791](https://t.me/inbox_tools/791) | 🟤 inbox | 🟡 MEDIUM | Сторонний relay, требует probe |
...
| A-010 | **ai.furry.vg** | неизвестен | GPT-6 Astra, Claude Fable 5, бонус за регистрацию | [post 795](https://t.me/inbox_tools/795) | 🟤 inbox | 🟡 MEDIUM | Под абуз |
| A-011 | **htai91.com** | неизвестен | $50 на баланс, GPT-5.6-Thinking, Claude Sonnet 5 Thinking, DeepSeek-v4-flash, GLM-5.2, Minimax-m3, Step-3.7, Grok (4.20, 4.3, 4.6). Поштучная тарификация: $0.01-0.05 за запрос | [post 790](https://t.me/inbox_tools/790) | 🟤 inbox | 🟡 MEDIUM | Закрытые корпоративные пулы (префиксы m365, nv, gk) |
