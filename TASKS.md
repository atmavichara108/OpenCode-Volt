...
| T-109 | AndroidOS Coordination Bridge: реализовать отдельный Git-backed canonical `coordination/bridge/` с Markdown task envelopes, handoffs, evidence и decisions; сначала read-only bootstrap и smoke test, без API/MCP/event bus/CRDT/Telegram, без application-code изменений. | P1 | [[AndroidOS]], [[06-Audits/2026-08-28-androidos-coordination-bridge-spec]], [[02-Methods/capability-routing]], [[03-Projects/dotfiles]] |
