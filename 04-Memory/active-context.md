...
- **Следующий шаг Ekstasis:** первое чтение «В поисках Нетленного» чтецом в сессии Ekstasis, затем полный проход картографа по трём частям; вопрос по стихам остаётся открытым.
